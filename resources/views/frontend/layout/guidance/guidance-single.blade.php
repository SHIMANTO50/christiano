...
@section('title', $guidance->guide_name . ' | Guides')
        ...
        <div class="section_home">
            <div class="section_left">
                ...
                <div class="techwave_fn_title_holder">
                    <h1 class="title title fn__animated_text">{{ $guidance->guide_name }}</h1>
                    <span class="author">
                ...
                <div class="container guide-details">
                    ...
                    <div class="category-wrapper">
                        <span>
                            {{ $guidance->category->category_name }}
                        </span>
                    </div>
                    <hr style="margin: 20px 0;">
                    <div class="description-wrapper">
                        <p>
                            {!! $guidance->guide_description !!}
                        </p>
                    </div>
                    ...
                    <div class="techwave_fn_interactive_list modern">
                        <ul>
                            @foreach ($latests as $latest)
                                <li>
                                    <div class="item">
                                        <a href="{{ route('guidances.single', ['slug' => $latest->guide_slug]) }}">
                                            <span class="icon">
                                                <img src="{{ asset($latest->feature_image) }}" alt="">
                                            </span>
                                            <div>

                                                <h2 class="title">{{ Str::limit($latest->guide_name, 30, '...') }}</h2>
                                                <div class="guide-create">
                                                    {{ Carbon\Carbon::parse($latest->created_at)->format('Y-m-d') }}
                                                </div>
                                            </div>
                    ...
                    <div class="techwave_fn_interactive_list modern">
                        <ul>
                            @foreach ($relatedes as $related)
                                <li>
                                    <div class="item">
                                        <a href="{{ route('guidances.single', ['slug' => $related->guide_slug]) }}">
                                            <span class="icon">
                                                <img src="{{ asset($related->feature_image) }}" alt="">
                                            </span>
                                            <div>

                                                <h2 class="title">{{ Str::limit($related->guide_name, 30, '...') }}</h2>
                                                <div class="guide-create">
                                                    {{ Carbon\Carbon::parse($related->created_at)->format('Y-m-d') }}
                                                </div>
                                            </div>
