                                ...
                                <ul>
                                    <li>
                                        ...
                                        <input id="journal_title" name="journal_title" type="text"
                                            placeholder="Journal Title *" value="{{ $journal->journal_title }}">
                                    ...
                                    <input type="hidden" name="type" id="journal_type" value="{{ $journal->type }}">
                                    <input type="hidden" name="update_id" id="journal_type" value="{{ $journal->id }}"
                                        readonly
                                    <li>
