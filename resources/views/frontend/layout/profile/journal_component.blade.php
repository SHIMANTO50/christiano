@php
    ...
    $journals = App\Models\Journal::where('user_id', auth()->user()->id)
...
@section('tab_section')
    ...
    <section class="user--post--area user--padding">
        ...
        <div class="row course-wrap">
            ...
            @forelse ($journals as $journal)
                <div class="col-lg-4 col-md-6 col-xl-3 col-12 my-5 mt-md-0">
                    ...
                    <div class="card h-100">
                        ...
                        <a class="bg-transparent" href="{{ route('single.journal', ['slug' => $journal->journal_slug]) }}">

                            <div class="journal-card-thumb">

                                <img class="thumbnail rounded-3" src="{{ asset($journal['journal_featured_image']) }}"
                            ...
                            <div class="journal-detail px-3">

                                <h3 class="text-hover">{{ Str::limit($journal['journal_title'], 20, '...') }}</h3>
            ...
            @empty
                ...
                <h1 class="text-danger h3">No Post Found</h1>
            @endforelse
