                    ...
                    <div class="card mb-4 mx-5">
                        ...
                        <div class="card-body">
                            <form action="{{ route('job.post.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" value="{{ $jobpost->id }}" name="id" readonly>
                                <div class="row">
                                    ...
                                    <div class="col-12 my-4">
                                        ...
                                        <textarea name="description" placeholder="Job Description"
                                            ...
                                            rows="10">{{ $jobpost->description }}</textarea>
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        <input type="file"
                                            ...
                                            name="logo" id="logo" data-default-file="{{ asset($jobpost->company->logo) }}">
                                    ...
                                    <div class="col-12 my-4">
                                        ...
                                        <textarea name="about" placeholder="Company About"
                                            ...
                                            rows="10">{{ $jobpost->company->about }}</textarea>
                                        @if ($errors->has('about'))
                                            <div class="invalid-feedback my-2">
                                                {{ $errors->first('about') }}
                                            </div>
