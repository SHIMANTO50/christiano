                            ...
                            <form action="{{ route('book.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 d-flex flex-column mb-3">
                                        ...
                                        <input name='tag' value="{{ $book->tag }}" id="tags"
                                    ...
                                    <div class="col-12 my-4">
                                        ...
                                        <textarea name="book_summary" class="form-control {{ $errors->has('book_summary') ? 'is-invalid' : '' }}"
                                            id="book_summary" cols="30" rows="10">{!! $book->book_summary !!}</textarea>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="file"
                                            ...
                                            data-default-file="{{ asset('/' . $book->feature_image) }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @endif
                                        <p class="mt-3"><b>File:</b> {{ asset('/' . $book->file) }}</p>
                                    </div>
                                    <div class="col-12">
