    ...
    <div class="app-content-area">
        <div class="write-journal p-0">
            <div class="write-journal-title">
                <h2>Update Journal post</h2>
                <a class="bg-transparent" href="{{ route('admin.journal.index') }}">
                    <i class="bi bi-chevron-left"></i> Back to Journal Page
                </a>
            </div>
            <form action="{{ route('admin.journal.update') }}" method="post" enctype="multipart/form-data"
                class="shadow-sm">
                @csrf
                <div class="mb-4">
                    <label for="journal_title" class="form-label">Title</label>
                    <input type="text" name="journal_title" value="{{ $journal->journal_title }}"
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" cols="30"
                        rows="10" placeholder="Leave a Description here" id="description">{{ $journal->description }}</textarea>
                ...
                <div class="col-md-12 d-flex flex-column mb-4">
                    ...
                    <input name='tag' value="{{ $journal->tag }}" id="tags"
                ...
                <input type="hidden" name="update_id" value="{{ $journal->id }}" readonly>
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <input type="file"
                        ...
                        data-default-file="{{ asset($journal->journal_featured_image) }}">
                ...
                <div class="w-journal-btn">
                    <div class="col-12 d-flex gap-2 justify-content-end">
                        <input type="submit" class="btn btn-success text-white w-auto" value="Update" />
