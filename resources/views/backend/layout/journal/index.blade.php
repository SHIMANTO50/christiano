            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class="text-end d-flex mx-3 justify-content-between align-items-center mb-4">
                        <h3>Journals</h3>
                        @can('create journal')
                            <a href="{{ route('admin.journal.create') }}" class="btn btn-primary mb-3">Write a Journal</a>
                        @endcan
                    </div>
...
@push('script')
    ...
    <script>
        ...
        function deleteItem(id) {
            var url = '{{ route('admin.journal.destroy', ':id') }}';
            $.ajax({
                type: "DELETE",
                url: url.replace(':id', id),
                success: function(resp) {
