            ...
            <div class="row mt-5">
                <div class="col-12">
                    <div class="text-end d-flex mx-3 justify-content-between align-items-center mb-4">
                        <h3>Bundle</h3>
                        @can('create bundle')
                            <a href="{{ route('bundle.create') }}" class="btn btn-primary mb-3">Create a Bundle</a>
                        @endcan
                    </div>
...
@push('script')
    ...
    <script>
        ...
        function statusChange(id) {
            var url = '{{ route('bundle.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            var url = '{{ route('bundle.destroy', ':id') }}';
            $.ajax({
                type: "DELETE",
                url: url.replace(':id', id),
                success: function(resp) {
