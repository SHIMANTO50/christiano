                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" name="title" id="title"
                                            class="form-control bg-light {{ $errors->has('title') ? 'is-invalid' : '' }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select disabled
                                            class="form-select text-capitalize  bg-light {{ $errors->has('time') ? 'is-invalid' : '' }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select disabled
                                            class="form-select text-capitalize bg-light {{ $errors->has('course_id') ? 'is-invalid' : '' }}"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select disabled
                                            class="form-select text-capitalize bg-light {{ $errors->has('module_id') ? 'is-invalid' : '' }}"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" name="option_three[]"
                                                                class="form-control" id="option_three_1"
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input type="text" id="option_four_1" name="option_four[]"
